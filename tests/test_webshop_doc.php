...
$product2 = array('id'=>2, 'name'=>'Product2', 'price'=>19.95, 'filename'=>'whey_delicious_vanilla_1000g.png'); // images werken niet
...
// Ik krijg het niet voor elkaar om de images te laten zien. Ze werken wel via index.
?>